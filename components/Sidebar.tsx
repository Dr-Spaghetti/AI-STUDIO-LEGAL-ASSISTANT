...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, user, onLogout, settings }) => {
  ...
  // Firm Logo Component - Text-based logo with green accent lines
  const FirmLogo = () => (
    <div className="flex flex-col items-start gap-0.5">
      ...
      <div className="flex items-center gap-2">
        <div className="flex flex-col gap-[3px]">
          <div className="w-6 h-[2px]" style={{ backgroundColor: primaryColor }}></div>
          <div className="w-6 h-[2px]" style={{ backgroundColor: primaryColor }}></div>
          <div className="w-6 h-[2px]" style={{ backgroundColor: primaryColor }}></div>
        </div>
        <span className="text-white font-bold text-[15px] tracking-[0.15em]">AFANADOR</span>
      </div>
    </div>
  );
