  ...
  return (
    <div className="w-64 bg-[#050505] border-r border-[#1E2128] flex flex-col h-full shrink-0">
      ...
      <div className="h-20 flex items-center px-6 border-b border-[#1E2128]">
        <div className="w-8 h-8 rounded-lg bg-[#00FFA3]/10 border border-[#00FFA3] flex items-center justify-center mr-3">
        ...
        <div>
          <h1 className="text-white font-bold text-sm tracking-wider">TED LAW FIRM</h1>
          <p className="text-[10px] text-gray-500 font-medium tracking-widest">AI RECEPTIONIST</p>
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all duration-200 group
                ${isActive 
                  ? 'bg-gradient-to-r from-[#00FFA3]/20 to-transparent text-[#00FFA3] border-l-2 border-[#00FFA3]' 
      ...
      <div className="p-6 border-t border-[#1E2128]">
          <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#00FFA3] to-[#008F5B] flex items-center justify-center text-black font-bold text-xs">
                  TL
              </div>
              <div>
                  <p className="text-xs text-white font-medium">Ted Law Admin</p>
...
const Icon = ({ name, active }: { name: string, active: boolean }) => {
    const colorClass = active ? "text-[#00FFA3]" : "text-gray-500 group-hover:text-white";
